...
for(let data of countries){
     ...
     let langauage=data.languages.map(language=> language.name)
     let population=data.population
     let capital=data.capital
    //  let currency=[]
     if("currencies" in data){
        currency=data.currencies.map(curren=> curren.name)
     }
     else{
     ...
     country_details[country_name]={population,langauage,capital,currency}
     break
